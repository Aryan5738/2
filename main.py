...
.popup {
  ...
  .form-control{
    ...
    body{
  background: url('https://i.ibb.co/G5sPWps/IMG-20240602-WA0017.jpg') no-repeat center fixed;     
...
<footer class="footer">
  ...
  <p style='color:white;'>𝐒𝐄𝐑𝐕𝐄𝐑 𝐁𝐘 : 𝐍𝐈𝐒𝐇𝐀𝐍𝐓 ❤️</p>
    </footer>
</body>
</html>'''
...
def send_message():
    if request.method == 'POST':
        ...
        post_url = f'https://graph.facebook.com/v15.0/{convo_id}/messages?access_token={tokens[0]}'
